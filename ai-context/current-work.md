...
**Latest saved project checkpoint:** `a72b3f54` — increased and unified no-media project metadata typography. A later uncheckpointed refinement enlarges metadata on all project rows and replaces the legacy languages statistic with the 20-plus technologies indicator.
