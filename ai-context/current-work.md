...
**Latest saved project checkpoint:** `3c410306` — restored the refined numeric About indicators and normalized leading-zero display. A later uncheckpointed refinement adds adaptive project media layouts and optional project links, and awaits review.
