...
**Latest saved project checkpoint:** `13a610d0` — added adaptive project media layouts and optional GitHub/live-project links. A later uncheckpointed refinement gives no-media projects a larger right-side Tech stack/Delivery column and accepts bare safe hostnames such as `googel.com` as HTTPS project links.
