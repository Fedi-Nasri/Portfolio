...
type Props = { section: CustomPortfolioSection; editable?: boolean; onComponentsChange?: (components: CustomSectionCanvasComponent[]) => void; presets?: CanvasLayoutPreset[]; onPresetsChange?: (presets: CanvasLayoutPreset[]) => void; onImageUpload?: (file: File, componentId: string) => void; uploadingImageId?: string | null; };
...
export function CustomSectionCanvas({ section, editable = false, onComponentsChange, presets = [], onPresetsChange, onImageUpload, uploadingImageId }: Props) {
