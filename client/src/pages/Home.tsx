      ...
      <main>
        <section id="home" className="reference-hero">
          ...
          <div className="hero-role-stack" aria-label="Professional focus areas">
            ...
            <div className="role-card browser-card"><div className="role-art infinity-art"><svg className="devops-frame-logo" viewBox="0 0 180 120" aria-hidden="true"><defs><linearGradient id="devopsFrameBlue" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#48b4ff" /><stop offset="52%" stopColor="#1877e8" /><stop offset="100%" stopColor="#2166d5" /></linearGradient><filter id="devopsFrameGlow" x="-25%" y="-25%" width="150%" height="150%"><feGaussianBlur stdDeviation="2.4" result="blur" /><feMerge><feMergeNode in="blur" /><feMergeNode in="SourceGraphic" /></feMerge></filter></defs><rect x="17" y="8" width="146" height="104" fill="none" stroke="url(#devopsFrameBlue)" strokeWidth="4" opacity=".9" /><g fill="none" stroke="url(#devopsFrameBlue)" strokeLinecap="round" strokeLinejoin="round" filter="url(#devopsFrameGlow)"><path d="M35 60 C52 25 78 25 99 60 C120 95 148 95 158 60 C148 25 120 25 99 60 C78 95 52 95 35 60" strokeWidth="5" /><path d="M42 60 C57 34 79 34 99 60 C119 86 141 86 151 60 C141 34 119 34 99 60 C79 86 57 86 42 60" strokeWidth="4" /><path d="M49 60 C62 42 81 42 99 60 C117 78 136 78 144 60 C136 42 117 42 99 60 C81 78 62 78 49 60" strokeWidth="3" /></g></svg></div><b>DevOps</b></div>
