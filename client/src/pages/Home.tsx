      ...
      <main>
        <section id="home" className="reference-hero">
          ...
          <div className="hero-role-stack" aria-label="Professional focus areas">
            <div className="role-card cloud-card"><div className="role-art cloud-art"><i /><span /><span /><span /></div><b>{hero.focusAreas[0] ?? "Cloud"}</b></div>
            ...
            <div className="role-card network-card"><div className="role-art network-art"><i /><span /><span /><span /></div><b>{hero.focusAreas[3] ?? "Security & Networking"}</b></div>
          </div>
        </section>
