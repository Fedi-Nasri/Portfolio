      ...
      <main>
        <section id="home" className="reference-hero">
          ...
          <div className="hero-role-stack" aria-label="Professional focus areas">
            ...
            <div className="role-card browser-card"><div className="role-art infinity-art"><svg className="devops-loop" viewBox="0 0 240 120" aria-hidden="true"><defs><linearGradient id="devopsFlowA" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#1f9cff" /><stop offset="48%" stopColor="#5a5cff" /><stop offset="100%" stopColor="#9b45ee" /></linearGradient><linearGradient id="devopsFlowB" x1="1" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#276ff8" /><stop offset="50%" stopColor="#45a8ff" /><stop offset="100%" stopColor="#50d0b2" /></linearGradient><filter id="devopsGlow" x="-30%" y="-50%" width="160%" height="200%"><feGaussianBlur stdDeviation="3" result="blur" /><feMerge><feMergeNode in="blur" /><feMergeNode in="SourceGraphic" /></feMerge></filter></defs><path d="M33 61 C54 27 84 27 119 61 C151 94 180 94 207 61" fill="none" stroke="url(#devopsFlowA)" strokeWidth="13" strokeLinecap="round" filter="url(#devopsGlow)" /><path d="M33 61 C56 94 87 94 121 61 C152 28 181 28 207 61" fill="none" stroke="url(#devopsFlowB)" strokeWidth="13" strokeLinecap="round" filter="url(#devopsGlow)" /><circle cx="33" cy="61" r="5" fill="#1f9cff" /><circle cx="207" cy="61" r="5" fill="#276ff8" /><path d="M198 51 L213 61 L198 71" fill="none" stroke="#276ff8" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" /><rect x="98" y="46" width="44" height="30" rx="12" fill="#fff" stroke="#dbe7ff" strokeWidth="2" /><path d="M109 55 L103 61 L109 67 M131 55 L137 61 L131 67 M116 69 L124 53" fill="none" stroke="#5676e8" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" /></svg></div><b>DevOps</b></div>
