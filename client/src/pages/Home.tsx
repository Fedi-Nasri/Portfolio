  ...
  return (
    <div className={`reference-portfolio${dimMode ? " dim-mode" : ""}`}>
      <header className="ref-header">
        <a href="#home" className="ref-brand" aria-label="Fedi Nasri home">fedi<span>.</span></a>
      ...
      <main>
        <section id="home" className="reference-hero">
          <div className="hero-copy-ref">
            ...
            <div className="hero-social-row">
              ...
              <a href={linkedInUrl} target="_blank" rel="noreferrer" aria-label="LinkedIn"><Linkedin size={15} /></a>
              <a href={githubUrl} target="_blank" rel="noreferrer" aria-label="GitHub"><Github size={15} /></a>
              <a href={`tel:${phone.replaceAll(" ", "")}`} aria-label="Call"><Phone size={15} /></a>
            </div>
          </div>
        ...
        <section id="contact" className="ref-contact">
          <div className="contact-ref-copy"><SectionTitle eyebrow="Let&apos;s Talk">Have an infrastructure challenge?<br />Let&apos;s solve it.</SectionTitle><p>I&apos;m building my next opportunity in cloud and network engineering. Availability details will be added here shortly.</p><div className="contact-facts"><div><span>Email</span><a href={`mailto:${email}`}>{email}</a></div><div><span>Phone</span><a href={`tel:${phone.replaceAll(" ", "")}`}>{phone}</a></div><div><span>Based in</span><p><MapPin size={15} /> Tunis, Tunisia · open to remote</p></div></div></div>
      ...
      <footer className="ref-footer"><div className="ref-brand">fedi<span>.</span></div><p>© 2026 Fedi Nasri · Crafted with care in Tunis</p><div><a href={linkedInUrl} target="_blank" rel="noreferrer">LinkedIn</a><a href={`mailto:${email}`}>Email</a><a href={`tel:${phone.replaceAll(" ", "")}`}>{phone}</a></div></footer>
