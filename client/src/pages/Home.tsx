    ...
    <div className={`reference-portfolio${dimMode ? " dim-mode" : ""}`}>
      <header className="ref-header">
        ...
        <nav className="ref-nav" aria-label="Primary navigation">
          <a href="#home">{navigation.home}</a><a href="#experience">{navigation.experience}</a><a href="#skills">{navigation.skills}</a><a href="#certifications">{navigation.certifications}</a><a href="#projects">{navigation.projects}</a><a href="#writing">{navigation.writing}</a><a href="#about">{navigation.about}</a>
        </nav>
        <div className="ref-header-actions">
          ...
          <a href="#contact" className="talk-button">{navigation.contact} <ArrowRight size={15} /></a>
      ...
      {mobileNav && <nav className="ref-mobile-nav" aria-label="Mobile navigation"><a onClick={closeNav} href="#home">{navigation.home}</a><a onClick={closeNav} href="#experience">{navigation.experience}</a><a onClick={closeNav} href="#skills">{navigation.skills}</a><a onClick={closeNav} href="#certifications">{navigation.certifications}</a><a onClick={closeNav} href="#projects">{navigation.projects}</a><a onClick={closeNav} href="#writing">{navigation.writing}</a><a onClick={closeNav} href="#about">{navigation.about}</a><a onClick={closeNav} className="ref-mobile-talk" href="#contact">{navigation.contact} <ArrowRight size={15} /></a></nav>}
      ...
      <main>
        ...
        <section id="experience" className="ref-section ref-experience">
          ...
          <div className="reference-timeline">{content.experience.map((item) => <article className={`reference-job${item.now ? " latest-job" : ""}`} key={`${item.date}-${item.company}`}><span className="timeline-marker" aria-hidden="true" /><div className="job-date"><RichText value={item.date} /></div><div className="job-name"><h3><RichText value={item.role} /></h3><p><RichText value={item.company} /></p></div><p className="job-copy"><RichText value={item.text} /></p><TagList items={item.tags} /></article>)}</div>
        </section>
