...
import { appendAboutStat, appendAboutTag, appendExperienceTag, appendSkillTool, appendSkillToolbox, duplicateListItem, insertExperienceTemplate, moveListItem, readAtPath, removeAboutStat as removeAboutStatAtIndex, removeAboutTag as removeAboutTagAtIndex, removeExperienceTag as removeExperienceTagAtIndex, removeListItem, removeSkillTool, removeSkillToolbox, updateAtPath, type ContentPath } from "@/lib/editorContent";
