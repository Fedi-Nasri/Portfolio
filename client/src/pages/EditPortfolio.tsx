...
import { addPortfolioSection, addProjectCaseStudyBlock as addProjectCaseStudyBlockToDraft, appendAboutStat, appendAboutTag, appendCertificate, appendCustomPortfolioSection, appendExperienceTag, appendProjectDelivery, appendProjectTech, appendSkillTool, appendSkillToolbox, appendWritingArticle, duplicateListItem, getPortfolioSectionOrder, insertExperienceTemplate, insertProjectTemplate, moveListItem, movePortfolioSection, readAtPath, removeAboutStat as removeAboutStatAtIndex, removeAboutTag as removeAboutTagAtIndex, removeCertificate, removeExperienceTag as removeExperienceTagAtIndex, removeListItem, removePortfolioSection, removeProject as removeProjectFromDraft, removeProjectCaseStudyBlock as removeProjectCaseStudyBlockFromDraft, removeProjectDelivery, removeProjectTech, removeSkillTool, removeSkillToolbox, removeWritingArticle, updateAtPath, type ContentPath, type ProjectCaseStudyBlock } from "@/lib/editorContent";
import { createDefaultFocusPositions, type PortfolioContent, type PortfolioSectionId } from "@shared/portfolio";
