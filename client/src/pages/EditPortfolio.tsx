...
function EditWorkspace() {
  ...
  useEffect(() => {
    if (editorQuery.data?.content) setDraft(hydrateExperienceDetails(editorQuery.data.content));
  }, [editorQuery.data]);
