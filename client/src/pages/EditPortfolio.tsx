...
import { appendAboutStat, appendAboutTag, appendExperienceTag, duplicateListItem, insertExperienceTemplate, moveListItem, readAtPath, removeExperienceTag as removeExperienceTagAtIndex, removeListItem, updateAtPath, type ContentPath } from "@/lib/editorContent";
...
function EditWorkspace() {
  ...
  return <div className="editor-shell">
    ...
    <div className="editor-workspace inspector-free"><main className="editor-canvas full-preview-canvas"><FullLivePreview content={draft} activeSection={activeSection} activePath={activePath} onSection={setActiveSection} onChange={handleChange} onSelect={selectPreviewPath} onAddTag={addAboutTag} onAddStat={addAboutStat} onInsertExperience={insertExperience} onAddExperienceTag={addExperienceTag} onRemoveExperience={removeExperience} onRemoveExperienceTag={removeExperienceTag} onUploadAsset={handleAssetUpload} uploadingAsset={uploadingAsset} /></main></div>
